      ...
      postUserData() {
        if (this.form.rank == 'Service Member') {
          const data = {
            ...
            S_in_collecting_system_policy_artifacts__c: this.form.S_in_collecting_system__policy_artifacts,
            K_of_CND_policies_procedures_and_regs__c: this.form.K_of_CND__policies_procedures_and_regs,
            ...
            K_of_access_control_and_application__c: this.form.K_of_access_control__and_application,
            K_of_network_traffic_flows_TCP_IP_OSI__c: this.form.K_of_network_traffic_flows__TCP_IP_OSI,
            ...
            A_to_assess_Defense_in_Depth__c: this.form.A_to_assess__Defense_in_Depth_,
            A_to_review_network_topologies__c: this.form.A_to_review__network_topologies_,
            A_to_perform_network_mapping__c: this.form.A_to_perform__network_mapping,
            E_in_providing_Tier_II_analysis__c: this.form.E_in_providing_Tier_II_analysis,
            A_to_review_detected_malicious_activity__c: this.form.A_to_review_detected_malicious_activity_,
            Knowledge_of_VPN_security__c: this.form.Knowledge_of_VPN_security,
            K_of_information_security_standards__c: this.form.K_of__information_security_standards,
            ...
            E_in_policies_procedures_and_standards__c: this.form.E_in__policies_procedures_and_standards,
